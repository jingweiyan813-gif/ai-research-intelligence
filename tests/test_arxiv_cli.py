...
def test_cli_airi_fetch_arxiv_works_with_mocked_connector(monkeypatch) -> None:  # type: ignore[no-untyped-def]
    ...
    result = runner.invoke(app, ["fetch", "arxiv", "--limit", "2", "--no-save"])
