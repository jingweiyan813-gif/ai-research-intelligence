...
def test_cli_airi_fetch_devpost_works_with_mocked_connector(monkeypatch) -> None:  # type: ignore[no-untyped-def]
    ...
    result = runner.invoke(app, ["fetch", "devpost", "--limit", "2", "--no-save"])
